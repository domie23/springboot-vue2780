    ...
    <div>
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">游戏资源管理注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="用户宠物号" class="input" v-if="tableName=='yonghu'">
                            <el-input v-model="ruleForm.yonghuPhone" autocomplete="off" placeholder="用户宠物号"  />
                        </el-form-item>
